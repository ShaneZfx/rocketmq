...
public class BrokerOuterAPI {
    ...
    private RegisterBrokerResult registerBroker(final String namesrvAddr,
                                                ...
                                                final byte[] body) throws RemotingCommandException,
            MQBrokerException, RemotingConnectException, RemotingSendRequestException, RemotingTimeoutException, InterruptedException {
